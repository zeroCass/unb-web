...
Revision ID: f678cd84e2f3
Revises: 
Create Date: 2023-06-30 18:33:08.034012
...
def upgrade():
    ...
    sa.Column('nota_questao', sa.Float(), nullable=True),
    sa.ForeignKeyConstraint(['id_exame'], ['exame.id'], ),
    sa.ForeignKeyConstraint(['id_questao'], ['questao.id'], ),
    sa.PrimaryKeyConstraint('id_exame', 'id_questao')
    )
    op.create_table('resposta_questao_exame',
    sa.Column('resposta_aluno', sa.String(length=255), nullable=True),
    sa.Column('nota_aluno_questao', sa.Float(), nullable=True),
    sa.Column('estudante_id', sa.Integer(), nullable=False),
    sa.Column('exame_id', sa.Integer(), nullable=False),
